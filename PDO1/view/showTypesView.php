...
include'../controller/showTypesController.php';
?>
<!DOCTYPE html>
<html lang="fr" dir="ltr">
    ...
    <body>
        ...
        <h1 class="title">Affichage des types de Shows</h1>
        <div class="container-fluid">
            <div class="row">
                <div class="firstTest offset-4 col-4 text-center">
                    <?php foreach ($showTypeList as $showTypesDetail) { ?>
                        <p><?= $showTypesDetail->type ?></p>
                    <?php } ?>
                </div>
            </div>
        </div>
